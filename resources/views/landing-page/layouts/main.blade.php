...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('storage/' . $configuration->logo) }}">
...
<!-- Include Bootstrap CSS for fiolter hostory job -->
...
<body>
    ...
    <!-- Optionally, include Bootstrap JS and jQuery for joh history filter-->

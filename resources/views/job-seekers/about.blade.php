            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="hero-cap text-center">
                        <h2 style="color: #28395a;">About Us</h2>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="right-caption">
                            ...
                            <div class="support-caption">
                                ...
                                <p>Our mission is to empower job seekers by providing them with the tools and resources they
                                    need to find meaningful employment. We aim to support employers in their quest to find

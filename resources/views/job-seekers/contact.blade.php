    ...
    <section class="contact-section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <form class="form-contact contact_form" action="{{ URL::to('/job-seekers/contact/store') }}" method="post"
                            enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <textarea class="form-control w-100" name="quote" id="quote" cols="30" rows="9" placeholder="Enter Quote"></textarea>
                                    @error('quote')
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <input type="text" class="form-control w-100" name="job" id="job" cols="30" rows="9" placeholder="Enter job"></input>
                                    @error('job')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
        ...
        <section class="contact-section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" action="test.html" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            {{-- 
                        @if (isset($testimoni))
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="name" id="name"
                                            cols="30" onfocus="this.placeholder = ''"
                                            onblur="this.placeholder = 'Enter name'" placeholder="Enter name"></input>
                                        @error('name')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
